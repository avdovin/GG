	...
	function autoScroll(direction,yPos)
	{
		...
		if(direction<0){
			if(document.documentElement.scrollTop>0){
				...
				if(useRectangle){
					dragObject.style.top = (el_y - mouse_y - 300 + yPos) + 'px';
				}else{
					dragDropMoveLayer.style.top = (el_y - mouse_y - 300 + yPos) + 'px';
				}			
			}else{
	...
	function moveDragableElement(e)
	{
		...
		if(useRectangle){
			...
			dragDropMoveLayer.style.top = (el_y - mouse_y - 300 + e.clientY) + 'px';
		}
