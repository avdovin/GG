...
function build_alias(node) {
	var form = jQuery(node).parents("form");
...
function set_route_alias(form) {
	if(jQuery('#' + form).length && jQuery('#' + form).find('input[name=alias]').length) {
		var alias = '';
		if(typeof jQuery('#' + form).find('input[name=alias]').data('backup-alias') == 'undefined') {
			alias = jQuery('#' + form).find('input[name=alias]').val();
			jQuery('#' + form).find('input[name=alias]').data('backup-alias', alias);
		} else {
			alias = jQuery('#' + form).find('input[name=alias]').data('backup-alias');
		}

		if(jQuery('#' + form).find('select[name=url_for]').val() && jQuery('#' + form).find('select[name=url_for] option:selected').data('alias')) {
			alias = jQuery('#' + form).find('select[name=url_for] option:selected').data('alias');
			jQuery('#' + form).find('input[name=alias]').val(alias).attr('readonly', true).click();
		} else {

			jQuery('#' + form).find('input[name=alias]').val(alias).attr('readonly', false).click();
		}
