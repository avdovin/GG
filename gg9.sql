...
VALUES
	...
	(16,'Ключевые слова','','keywords','lkey','type=text\nrating=3\ngroup=1\nfilter=1\nqedit=1\nhelp=Ключевые слова и выражения, разделенные запятой, которые соответствуют данному тексту. Используется для оптимизации страницы под поисковые системы. Указанные слова в данном поле должны обязательно присутствовать в тексте — в противном случае они не будут учитываться поисковыми машинами.\ndirview=1\nfileview=1','2010-10-29 12:23:39'),
...
VALUES
	(1,'Главная страница','','main','Главная страница','Главная страница','Главная страница',1,0,'root',0,1,1,'','main','','<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.</p>\n\n<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat vol</p>','2015-10-26 14:07:33','2012-03-05 13:28:44'),
	(2,'О студии','','about','О студии','О студии','О студии',3,0,'root',1,1,1,'','default','','','2014-02-20 14:20:27','2012-10-19 12:43:19'),
	(3,'Портфолио','','portfolio','Портфолио','Портфолио','Портфолио',5,0,'root',1,1,1,'','default','','','2014-02-20 14:20:27','2012-10-19 12:43:56'),
	(4,'Контакты','','contacts','Контакты','Контакты','Контакты',6,0,'root',1,1,1,'','default','feedback','','2014-02-20 14:20:27','2012-10-19 12:44:19');
