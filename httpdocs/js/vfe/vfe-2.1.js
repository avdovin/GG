...
var vfe = (function() {
    if(typeof CKEDITOR != 'undefined') CKEDITOR.disableAutoInline = true;
      ...
      $.buttons.vfe.click(function(){
          if (!jQuery(this).is(".current")) {
              ...
              if (typeof CKEDITOR != 'undefined') {
                  ...
                  jQuery(".vfe-editablecontent").each(function(){
                      var element_id = jQuery(this).attr('id');
                      var element_textid = jQuery(this).data("vfe-textid");
                      var lang = jQuery(this).data('lang');

                    CKEDITOR.inline( element_id, {
                      toolbar: 'vfe',
                // floatSpaceDockedOffsetY: 200,
                // floatSpaceDockedOffsetX: 200,
                // floatSpacePinnedOffsetX: 300,
              // floatSpacePinnedOffsetY: 300,
                      on: {
                          blur: function(event) {
