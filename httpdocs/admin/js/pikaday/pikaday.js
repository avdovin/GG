...
}(this, function (moment)
{
    ...
    renderTime = function(hh, mm, ss, opts)
    {
        ...
        var to_return = '<table cellpadding="0" cellspacing="0" class="pika-time"><tbody><tr>' +
            renderTimePicker(hours_arr, hh, 'pika-select-hour', function(i) {
                if (opts.use24hour) {
                    return i;
                } else {
            ...
            '<td>:</td>' +
            renderTimePicker(min_arr, mm, 'pika-select-minute', function(i) { if (i < 10) return "0" + i; return i });

        if (opts.showSeconds) {
            to_return += '<td>:</td>' +
                renderTimePicker(min_arr, ss, 'pika-select-second', function(i) { if (i < 10) return "0" + i; return i });
        }
